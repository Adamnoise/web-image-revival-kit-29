...
const Brandbook = () => {
  ...
  return (
    <AppLayout backgroundVariant="gradient" headerTitle="Design System">
        ...
        <TabsContent value="colors" className="mt-6 space-y-8">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              ...
              <ColorCard name="Accent Blue" color="bg-[#3b82f6]" value="#3b82f6 (blue-500)" />
              <ColorCard name="Accent Red" color="bg-[#ef4444]" value="#ef4444 (red-500)" />
              <ColorCard name="Accent Green" color="bg-[#10b981]" value="#10b981 (emerald-500)" />
            </div>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-3">Cyberpunk Palette</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <ColorCard name="Neon Cyan" color="bg-[#00F5FF]" value="#00F5FF (neon.cyan)" />
              <ColorCard name="Neon Purple" color="bg-[#B026FF]" value="#B026FF (neon.purple)" />
              <ColorCard name="Neon Yellow" color="bg-[#FAFF00]" value="#FAFF00 (neon.yellow)" />
              <ColorCard name="Dark Background" color="bg-[#070A14]" value="#070A14" />
            </div>
          </div>
        </TabsContent>
            ...
            <div>
              ...
              <Card variant="glass">
                <CardContent className="p-6 space-y-4">
                  <div>
                    <Badge variant="blue" className="mb-1">text-xl</Badge>
                    <p className="text-xl">Headers (Matches header)</p>
                  </div>
                  <div>
                    <Badge variant="blue" className="mb-1">text-base</Badge>
                    <p className="text-base">Subheaders</p>
                  </div>
                  <div>
                    <Badge variant="blue" className="mb-1">text-sm</Badge>
                    <p className="text-sm">Body Text</p>
                  </div>
                  <div>
                    <Badge variant="blue" className="mb-1">text-xs</Badge>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Card variant="live">
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <span className="text-gray-400">:</span>
                      <span className="text-lg font-bold">0</span>
                      <Clock className="h-3 w-3 text-[#ef4444] animate-pulse" />
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card variant="cyber">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-sm font-medium">Cyberpunk Card</div>
                      <Badge variant="cyber">CYBER</Badge>
                    </div>
                    <div className="flex items-center justify-between mb-2">
                      <div className="text-xs text-white/50">Status</div>
                      <div className="text-xs text-[#00F5FF]">ACTIVE</div>
                    </div>
                    <div className="h-1 bg-[#1A1E2E] rounded-full overflow-hidden">
                      <div className="h-full w-[75%] bg-gradient-to-r from-[#00F5FF] to-[#0099FF] rounded-full"></div>
                    </div>
                  </CardContent>
                </Card>
              </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button variant="cyber-purple">Cyber Purple</Button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Badge variant="cyber">Cyber</Badge>
                <Badge variant="cyber-purple">Purple</Badge>
                <Badge variant="cyber-yellow">Yellow</Badge>
              </div>
            </div>
          </div>
        </TabsContent>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="group p-4 bg-black/20 rounded-lg border border-white/5">
                  <p className="text-sm">Item <span className="text-[#3b82f6] group-hover:translate-x-1 inline-block transition-transform duration-300">→</span></p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="h-2 w-2 rounded-full bg-[#ef4444] animate-ping"></div>
